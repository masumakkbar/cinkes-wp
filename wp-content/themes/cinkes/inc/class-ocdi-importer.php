...
class OCDI_Demo_Importer {
    ...
    public function __construct() {
        ...
        add_action( 'init', [$this, 'cinkes_toolkit_rewrite_flush'] );
    }
    ...
    public function import_files_config() {
		...
		$home_prevs = array(
			'cinkes_home_1' => array(
				'title' => __( 'Home 1', 'cinkes' ),
				'page'  => __( 'home', 'cinkes' ),
				'screenshot' => get_template_directory_uri().'/inc/img/ocdi/home-1.jpg',
				'preview_link' => 'https://themepure.net/wp/cinkes/',
			)
		);
        ...
        foreach ( $home_prevs as $key => $prev ) {
            ...
            $config[] = [
                ...
                'import_notice'                => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'cinkes' ),
            ];
        }
    ...
    public function cinkes_toolkit_rewrite_flush() {
